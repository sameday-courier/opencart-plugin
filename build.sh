...
if [ $VERSION -eq 2 ]; then
    rm -f sameday.$VERSION.ocmod.zip
    rm -rf upload
    mkdir upload
    ...
    cp admin/view/template/extension/shipping/sameday*.twig upload/admin/view/template/shipping/
    cp admin/view/template/extension/shipping/sameday*.tpl upload/admin/view/template/shipping/ 2>/dev/null || true
    ...
    cp catalog/model/extension/shipping/sameday_catalog_model.3.php upload/catalog/model/shipping/
    cp catalog/model/extension/shipping/sameday_catalog_model.4.php upload/catalog/model/shipping/
    cp catalog/language/en-gb/extension/shipping/sameday.php upload/catalog/language/en-gb/shipping/
